...
| generator.entity.package | 否 | ---- | com.github.lyrric.entity | entity包名，如果要生成entity则必须指定 |
| generator.mapper.enable | 否 | true | true/false | 是否生成mapper |
| generator.mapper.project | 否 | src/main/java | ---- | mapper生成位置，默认是单模块应用 |
| generator.mapper.package | 否 | ---- |com.github.lyrric.mapper | mapper包名，如果要生成mapper则必须指定 |
...
| generator.service.package | 否 | ---- |com.github.lyrric.service | service包名，如果要生成service则必须指定 |
...
| generator.serviceImpl.package | 否 | ---- |com.github.lyrric.service.impl | serviceImpl包名，如果要生成serviceImpl则必须指定 |
